...
const Header = () => {
  ...
  return (
    <header className="flex items-center justify-between px-4 py-2 bg-white dark:bg-zinc-900 border-b dark:border-zinc-800">
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" onClick={toggleSidebar} className="dark:text-white">
        ...
        <Link href="/" className="flex items-center gap-1">
          ...
          <span className="text-xl font-medium dark:text-white hidden sm:inline">YourTube</span>
      ...
      >
        <div className="flex flex-1">
          <Input
            ...
            className="rounded-l-full border-r-0 focus-visible:ring-0 dark:bg-zinc-800 dark:border-zinc-700 dark:text-white"
          />
          <Button
            type="submit"
            className="rounded-r-full px-6 bg-gray-50 hover:bg-gray-100 text-gray-600 border border-l-0 dark:bg-zinc-800 dark:hover:bg-zinc-700 dark:border-zinc-700 dark:text-gray-300"
          >
            <Search className="w-5 h-5" />
          </Button>
        </div>
        <Button variant="ghost" size="icon" className="rounded-full dark:text-white dark:hover:bg-zinc-800">
